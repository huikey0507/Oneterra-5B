...
from xsam.model.xsam_dev_sar_align import XSamSarAlignModel
...
s2_pretrained_pth = (
    checkpoint_dir
    + "s3_mixed_fineture_v3.2/iter_70504.pth"
)  # noqa: E501
...
sar_pano_root = oneterra_data_root + "sarseg/pansar2/"
...
val_datasets = [
    ...
    dict(
        type=OVSegDataset,
        data_path=sar_pano_root + "annotations/panoptic_val2017.json",
        image_folder=sar_pano_root + "val2017",
        panseg_map_folder=sar_pano_root + "annotations/panoptic_val2017",
        data_mode="eval",
        tokenizer=tokenizer,
        task_name="ovseg",
   ...
   # 2b. Vaihingen OVSeg — panoptic (PQ / SQ / RQ)
    dict(
        type=OVSegDataset,
        data_path=vaihingen_pano_root + "annotations/panoptic_annotations.json",
        image_folder=vaihingen_root + "img_dir/val/",
        panseg_map_folder=vaihingen_pano_root + "panoptic_rgb_ids/",
        data_mode="eval",
        tokenizer=tokenizer,
        task_name="ovseg",
        data_name="vaihingen_panoptic_ovseg_val",
        output_ids_with_output=output_ids_with_output,
        cond_type=cond_type,
        special_tokens=special_tokens,
        image_processor=image_processor,
    ...
    dict(
        ...
        data_path=vaihingen_pano_root + "annotations/panoptic_annotations.json",
        image_folder=vaihingen_root + "img_dir/val/",
        semseg_map_folder=vaihingen_root + "ann_dir/val_gt_remapped/remap_cocopano_gt_id/",
        ignore_label=5,
        data_mode="eval",
        tokenizer=tokenizer,
        task_name="ovseg",
        data_name="vaihingen_semantic_ovseg_val",
        output_ids_with_output=output_ids_with_output,
        cond_type=cond_type,
        special_tokens=special_tokens,
        image_processor=image_processor,
    ...
    dict(
        type=OVSegDataset,
        data_path=vaihingen_pano_root + "annotations/instance_annotations.json",
        image_folder=vaihingen_root + "img_dir/val/",
        data_mode="eval",
        tokenizer=tokenizer,
        task_name="ovseg",
        data_name="vaihingen_instance_ovseg_val",
        output_ids_with_output=output_ids_with_output,
        cond_type=cond_type,
        special_tokens=special_tokens,
        image_processor=image_processor,
    ...
    # 20. Image Conversation (VQA) - FIT-RSFG-Bench VQA (full)
    dict(
        type=ImgConvDataset,
    ...
    # 20b. Image Conversation (VQA) - FIT-RSFG-Bench VQA (debug50)
    dict(
        type=ImgConvDataset,
        data_path=code_dir + "../datas/debug_subsets/FIT-RSFG/test_FITRS_vqa_eval_qwenvl_first50.json",
        tokenizer=tokenizer,
        cond_type=cond_type,
        special_tokens=special_tokens,
        image_folder=imgconv_cc_data_root + "raw_data/imgv2_split_512_100_vaild",
        ...
        extra_image_processor=extra_image_processor,
        task_name="imgconv",
        data_name="imgconv_FIT-RSFG_Benchmark_VQA_debug50",
        dataset_map_fn=dict(
            type=dataset_map_fn_factory,
            fn=image_conv_map_fn,
        ),
    ...
    # 30. Image Conversation (VQA, SAR) - SAR-LANG_VQA (full)
    dict(
        type=ImgConvDataset,
    ...
    # 30b. Image Conversation (VQA, SAR) - SAR-LANG_VQA (debug50)
    dict(
        type=ImgConvDataset,
        data_path=code_dir + "../datas/debug_subsets/SARLANG/test_SARLANG_VQA_first50.json",
        tokenizer=tokenizer,
        cond_type=cond_type,
        special_tokens=special_tokens,
        image_folder="/mnt_llm_A100_V1/yangsen/datasets",
        ...
        extra_image_processor=extra_image_processor,
        task_name="imgconv",
        data_name="imgconv_SAR-LANG_VQA_debug50",
        dataset_map_fn=dict(
            type=dataset_map_fn_factory,
            fn=image_conv_map_fn,
        ),
