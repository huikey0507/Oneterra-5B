...
checkpoints_dir = work_dir = getenv("WORK_DIR", "./checkpoints/")
...
s1_pretrained_pth = checkpoints_dir + "s1_seg_finetune/xsam_sota_s1_finetune/iter_66000.pth/pytorch_model.bin"
